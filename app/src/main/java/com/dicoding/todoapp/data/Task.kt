...
data class Task(
    @PrimaryKey @NonNull @ColumnInfo(name = "id") var id: Int = 0,
    @NonNull @ColumnInfo(name = "title") var title: String = "",
    @NonNull @ColumnInfo(name = "description") var description: String = "",
    @NonNull @ColumnInfo(name = "dueDateMillis") var dueDateMillis: Long = 0,
    @NonNull @ColumnInfo(name = "completed") var isCompleted: Boolean = false
)
